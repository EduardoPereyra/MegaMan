...
public class SniperJoeController : MonoBehaviour
{
 Animator animator;
    ...
    private void ShootBullet()
    {
        ...
        bullet.GetComponent<Bullet>().SetBulletType(Bullet.BulletType.MiniGreen);
        bullet.GetComponent<Bullet>().SetDamage(enemyController.bulletDamage);
        bullet.GetComponent<Bullet>().SetSpeed(enemyController.bulletSpeed);
        bullet.GetComponent<Bullet>().SetDirection(bulletVector);
        bullet.GetComponent<Bullet>().SetCollideWithTags(new [] {"Player"});
        bullet.GetComponent<Bullet>().SetDestroyDelay(5f);
