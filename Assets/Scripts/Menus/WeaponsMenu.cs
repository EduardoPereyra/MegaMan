...
public class WeaponsMenu : MonoBehaviour
{
    ...
    public void SetMenuPalette(MenuPalettes palette)
    {
        ...
        switch (menuPalette)
        {
            case MenuPalettes.Custom:
                // custom colors
                colorSwap.SetPrimaryColor((int)SwapIndex.Block1, ColorSwap.ColorFromInt(customColorBlockLight));
                colorSwap.SetSecondaryColor((int)SwapIndex.Block2, ColorSwap.ColorFromInt(customColorBlockDark));
                colorSwap.SetBackgroundColor((int)SwapIndex.Background, ColorSwap.ColorFromInt(customColorBackground));
                break;
            case MenuPalettes.BombMan:
                // light green, dark green, brown
                colorSwap.SetPrimaryColor((int)SwapIndex.Block1, ColorSwap.ColorFromInt(0x80D010));
                colorSwap.SetSecondaryColor((int)SwapIndex.Block2, ColorSwap.ColorFromInt(0x009400));
                colorSwap.SetBackgroundColor((int)SwapIndex.Background, ColorSwap.ColorFromInt(0x7C0800));
                break;
            case MenuPalettes.CutMan:
            case MenuPalettes.Wily3:
                // white, medium gray, dark gray
                colorSwap.SetPrimaryColor((int)SwapIndex.Block1, ColorSwap.ColorFromInt(0xFCFCFC));
                colorSwap.SetSecondaryColor((int)SwapIndex.Block2, ColorSwap.ColorFromInt(0xBCBCBC));
                colorSwap.SetBackgroundColor((int)SwapIndex.Background, ColorSwap.ColorFromInt(0x747474));
                break;
            case MenuPalettes.ElecMan:
            case MenuPalettes.Wily4:
                // white, orange, dark orange
                colorSwap.SetPrimaryColor((int)SwapIndex.Block1, ColorSwap.ColorFromInt(0xFCFCFC));
                colorSwap.SetSecondaryColor((int)SwapIndex.Block2, ColorSwap.ColorFromInt(0xFC9838));
                colorSwap.SetBackgroundColor((int)SwapIndex.Background, ColorSwap.ColorFromInt(0xC84C0C));
                break;
            case MenuPalettes.FireMan:
                // white, medium gray, dark red
                colorSwap.SetPrimaryColor((int)SwapIndex.Block1, ColorSwap.ColorFromInt(0xFCFCFC));
                colorSwap.SetSecondaryColor((int)SwapIndex.Block2, ColorSwap.ColorFromInt(0xBCBCBC));
                colorSwap.SetBackgroundColor((int)SwapIndex.Background, ColorSwap.ColorFromInt(0xA40000));
                break;
            case MenuPalettes.GutsMan:
                // pink, dark orange, brown
                colorSwap.SetPrimaryColor((int)SwapIndex.Block1, ColorSwap.ColorFromInt(0xFC7460));
                colorSwap.SetSecondaryColor((int)SwapIndex.Block2, ColorSwap.ColorFromInt(0xC84C0C));
                colorSwap.SetBackgroundColor((int)SwapIndex.Background, ColorSwap.ColorFromInt(0x7C0800));
                break;
            case MenuPalettes.IceMan:
                // white, dark green, teal
                colorSwap.SetPrimaryColor((int)SwapIndex.Block1, ColorSwap.ColorFromInt(0xFCFCFC));
                colorSwap.SetSecondaryColor((int)SwapIndex.Block2, ColorSwap.ColorFromInt(0x004400));
                colorSwap.SetBackgroundColor((int)SwapIndex.Background, ColorSwap.ColorFromInt(0x008088));
                break;
            case MenuPalettes.Wily1:
                // white, dark gray, blue
                colorSwap.SetPrimaryColor((int)SwapIndex.Block1, ColorSwap.ColorFromInt(0xFCFCFC));
                colorSwap.SetSecondaryColor((int)SwapIndex.Block2, ColorSwap.ColorFromInt(0x747474));
                colorSwap.SetBackgroundColor((int)SwapIndex.Background, ColorSwap.ColorFromInt(0x0000A8));
                break;
            case MenuPalettes.Wily2:
                // green, mustard, teal
                colorSwap.SetPrimaryColor((int)SwapIndex.Block1, ColorSwap.ColorFromInt(0x58F898));
                colorSwap.SetSecondaryColor((int)SwapIndex.Block2, ColorSwap.ColorFromInt(0x887000));
                colorSwap.SetBackgroundColor((int)SwapIndex.Background, ColorSwap.ColorFromInt(0x008088));
                break;
            case MenuPalettes.Wily4_1:
                // red, pink, black
                colorSwap.SetPrimaryColor((int)SwapIndex.Block1, ColorSwap.ColorFromInt(0xD82800));
                colorSwap.SetSecondaryColor((int)SwapIndex.Block2, ColorSwap.ColorFromInt(0xFC7460));
                colorSwap.SetBackgroundColor((int)SwapIndex.Background, ColorSwap.ColorFromInt(0x000000));
                break;
            case MenuPalettes.Wily4_2:
                // brown, light yellow, orange
                colorSwap.SetPrimaryColor((int)SwapIndex.Block1, ColorSwap.ColorFromInt(0x7C0800));
                colorSwap.SetSecondaryColor((int)SwapIndex.Block2, ColorSwap.ColorFromInt(0xFCD8A8));
                colorSwap.SetBackgroundColor((int)SwapIndex.Background, ColorSwap.ColorFromInt(0xC84C0C));
                break;
        }
    }
    ...
    {
        // Texture tex = Icon.GetComponent<Image>().sprite.texture;
        colorSwap.SetMainSprite(Icon.GetComponent<Image>().sprite);
        // use a custom color scheme with ColorSwap
        colorSwap.SetPrimaryColor((int)SwapIndex.Block1, ColorSwap.ColorFromInt(block1Color));
        colorSwap.SetSecondaryColor((int)SwapIndex.Block2, ColorSwap.ColorFromInt(block2Color));
        colorSwap.SetBackgroundColor((int)SwapIndex.Background, ColorSwap.ColorFromInt(backgroundColor));
    }
}
