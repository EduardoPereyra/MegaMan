    ...
    void PlayCutManAnimation()
    {
        ...
        if (enemySelection == (int)GameManager.StagesList.CutMan)
        {
            ...
            if (UtilityFunctions.InTime(runTime, 0.001f))
            {
                ...
                enemyChars[enemySelection].GetComponent<Rigidbody2D>().linearVelocity = enemyJumpVectors[enemySelection];
            ...
            if (UtilityFunctions.InTime(runTime, 0.001f, 3.0f))
            {
                if (animationStep == 1)
                {
                    ...
                    if (enemyChars[enemySelection].GetComponent<Rigidbody2D>().linearVelocity.y <= 0 &&
        ...
        if (enemySelection == (int)GameManager.StagesList.BombMan)
        {
            ...
            if (animationStep == 2)
            {
                ...
                if (UtilityFunctions.InTime(runTime, thisTime + 1.35f))
                {
                    ...
                    bomb.GetComponent<Rigidbody2D>().linearVelocity = new Vector2(0, 2f);
                }
