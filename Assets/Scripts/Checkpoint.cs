...
public class Checkpoint : MonoBehaviour
{
    ...
    public void CheckpointReached()
    {
        ...
        if (checkpointType != CheckpointType.Manager && !checkpointReached)
        {
            ...
            if (callEventWhenReached) checkpointEvent.Invoke();
        }
    }
    ...
    public void UpdateScene()
    {
        ...
        if (checkpointType == CheckpointType.Manager && checkpointReached)
        {
            ...
            {
                cameraFollow.boundsMin = cameraMinPosition;
                cameraFollow.boundsMax = cameraMaxPosition;
                cameraFollow.gameObject.transform.position = cameraPosition;
            }
        ...
        foreach (Checkpoint checkpoint in checkpoints)
        {
            ...
            if (checkpoint.checkpointType != CheckpointType.Manager)
            {
                CheckpointSettings checkpointSettings = new CheckpointSettings
                {
                    ...
                    checkpointReached = checkpoint.checkpointReached
                };
    ...
    private void SaveCameraTransitions()
    {
        ...
        CameraTransition[] cameraTransitions = FindObjectsByType<CameraTransition>();
