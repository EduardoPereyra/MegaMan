...
public class KillerBombController:MonoBehaviour
{
    ...
    [SerializeField] RuntimeAnimatorController racRedKillerBomb;
    [SerializeField] RuntimeAnimatorController racOrangeKillerBomb;
    [SerializeField] RuntimeAnimatorController racBlueKillerBomb;
    ...
    private void SetAnimatorController()
    {
        switch (killerBombColor)
        {
            case KillerBombColors.Red:
                animator.runtimeAnimatorController = racRedKillerBomb;
                break;
            case KillerBombColors.Orange:
                animator.runtimeAnimatorController = racOrangeKillerBomb;
                break;
            case KillerBombColors.Blue:
                animator.runtimeAnimatorController = racBlueKillerBomb;
                break;
        }
    }
}
